...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public partial class MainWindow
    {
        ...
        public MainWindow()
        {
            ...
            string createString = "CREATE TABLE Prod (Name VARCHAR(50), Cost INT, Type VARCHAR(50))"; //YOUR SQL COMMAND TO CREATE A TABLE
            SqlConnection connection = new SqlConnection("Data Source=(LocalDB)\\v11.0;AttachDbFilename=C:\\Users\\lokibg2\\Documents\\Products.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            */
            ...
            string createString = "Insert into Prod values(@Name,@Cost,@Type)"; //YOUR SQL COMMAND TO CREATE A TABLE
            SqlConnection connection = new SqlConnection("Data Source=(LocalDB)\\v11.0;AttachDbFilename=C:\\Users\\lokibg2\\Documents\\Products.mdf;Integrated Security=True;Connect Timeout=30");
            SqlCommand insert = new SqlCommand(createString, connection);
            insert.Parameters.AddWithValue("@Name","Apples");
            insert.Parameters.AddWithValue("@Cost", "60");
            insert.Parameters.AddWithValue("@Type", "Fruits");
            connection.Open();
            insert.ExecuteNonQuery();
            connection.Close();
            

            String[] names = {"Snacks","Fruits","Vegetables","Cosmetics","Groceries"};
            for (var index = 0; index < 5; ++index)
            {
                BitmapImage bi = new BitmapImage();
                bi.BeginInit();
                bi.UriSource = new Uri("C:\\Users\\lokibg2\\Documents\\khkn\\ControlsBasics-WPF\\Images\\logo"+ index + ".jpg", UriKind.Relative);
                bi.EndInit();        
